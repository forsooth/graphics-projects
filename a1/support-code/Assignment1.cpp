...
int main(int argc, char* argv[])
{
        ...
        GLUI_Spinner *s1 = new GLUI_Spinner(render_panel, "Segments X:", &segmentsX);
        s1->set_int_limits(3, 60);
        GLUI_Spinner *s2 = new GLUI_Spinner(render_panel, "Segments Y:", &segmentsY);
        s2->set_int_limits(3, 60);
