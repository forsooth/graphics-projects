...
public:
    ...
    bool operator==(const Matrix m) const {
        if (IN_RANGE((p[0]), (m[0])) && IN_RANGE((p[1]), (m[1])) && IN_RANGE((p[2]), (m[2])) && IN_RANGE((p[3]), (m[3])) &&
            IN_RANGE((p[4]), (m[4])) && IN_RANGE((p[5]), (m[5])) && IN_RANGE((p[6]), (m[6])) && IN_RANGE((p[7]), (m[7])) &&
            IN_RANGE((p[8]), (m[8])) && IN_RANGE((p[9]), (m[9])) && IN_RANGE((p[10]), (m[10])) && IN_RANGE((p[11]), (m[11])) &&
            IN_RANGE((p[12]), (m[12])) && IN_RANGE((p[13]), (m[13])) && IN_RANGE((p[14]), (m[14])) && IN_RANGE((p[15]), (m[15])))
            return 1;
        return 0;
    }
...
inline Matrix inv_scale_mat(const Vector &v) {
    if (!IN_RANGE((v[0]), 0) && !IN_RANGE((v[1]), 0) && !IN_RANGE((v[2]), 0)) {
