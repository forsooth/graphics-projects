...
public:
    ...
    SceneColor operator*(float factor) {
        SceneColor sc;
        sc.r = this->r * factor;
        sc.g = this->g * factor;
        sc.b = this->b * factor;
    ...
    SceneColor operator*(const SceneColor &c1) {
        SceneColor sc;
        sc.r = this->r * c1.r;
        sc.g = this->g * c1.g;
        sc.b = this->b * c1.b;
...
inline SceneColor operator*(float factor, const SceneColor &sc) {
        SceneColor newcolor;
        newcolor.r = factor * sc.r;
        newcolor.g = factor * sc.g;
        newcolor.b = factor * sc.b;
        newcolor.a = sc.a;
        return newcolor;
}
